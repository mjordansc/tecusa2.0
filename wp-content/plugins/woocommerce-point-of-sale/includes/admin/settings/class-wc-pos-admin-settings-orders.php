	...
	public static function get_settings() {
		...
		return apply_filters(
			...
			[
				...
				[
					'name'     => __( 'Order Status Management', 'woocommerce-point-of-sale' ),
					'id'       => 'wc_pos_flexible_order_status_changes',
					'type'     => 'checkbox',
					'desc'     => __( 'Allow order status management', 'woocommerce-point-of-sale' ),
					'desc_tip' => __( 'Check this box to permit changing the order status to any status. With this disabled, status updates are constrained to default order transitions.', 'woocommerce-point-of-sale' ),
					'default'  => 'no',
					'autoload' => true,
				],
				[
