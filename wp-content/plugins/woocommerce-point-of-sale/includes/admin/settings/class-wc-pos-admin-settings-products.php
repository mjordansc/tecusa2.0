	...
	public static function get_settings() {
		...
		return apply_filters(
			...
			[
				...
				[
					'title'    => __( 'Uncategorized Products', 'woocommerce-point-of-sale' ),
					'desc'     => __( 'Hide the Uncategorized product category', 'woocommerce-point-of-sale' ),
					'desc_tip' => __( 'Check this box to hide the Uncategorized product category from the product grid.', 'woocommerce-point-of-sale' ),
				...
				[
					'title'    => __( 'Variations Display', 'woocommerce-point-of-sale' ),
					'desc_tip' => __( 'Select how procuct variations should be displayed.', 'woocommerce-point-of-sale' ),
					'id'       => 'wc_pos_variations_display',
					'default'  => 'tiles',
					'class'    => 'wc-enhanced-select',
					'type'     => 'select',
					'options'  => [
						'tiles'    => __( 'Display product attributes as tiles', 'woocommerce-point-of-sale' ),
						'dropdown' => __( 'Use dropdown for variation selection', 'woocommerce-point-of-sale' ),
						'all'      => __( 'Display all the available variations at once', 'woocommerce-point-of-sale' ),
					],
				],
				[
