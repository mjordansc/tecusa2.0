		...
		return apply_filters(
			...
			[
				...
				[
					...
					'desc_tip' => sprintf( __( 'Allows you to use keyboard shortcuts to execute popular and frequent actions. Click %1$shere%2$s for the list of keyboard shortcuts.', 'woocommerce-point-of-sale' ), '<a href="https://woo.com/document/point-of-sale/#section-9" target="_blank">', '</a>' ),
				...
				[
					'name'     => __( 'Sales Total', 'woocommerce-point-of-sale' ),
					'desc_tip' => __( 'Select the user roles for which sales total is displayed.', 'woocommerce-point-of-sale' ),
					'id'       => 'wc_pos_display_total_sales_roles',
					'class'    => 'wc-enhanced-select',
					'type'     => 'multiselect',
					/**
					 * User roles for which total sales is displayed.
					 *
					 * @since 6.0.0
					 */
					'options'  => apply_filters(
						'wc_pos_display_total_sales_roles',
						[
							'register_clerk' => __( 'Register clerk', 'woocommerce-point-of-sale' ),
							'outlet_manager' => __( 'Outlet manager', 'woocommerce-point-of-sale' ),
							'shop_manager'   => __( 'Shop manager', 'woocommerce-point-of-sale' ),
					...
					'default'  => [ 'outlet_manager', 'shop_manager', 'register_clerk' ],
				],
				[
					'title'    => __( 'User Sales Total', 'woocommerce-point-of-sale' ),
					'desc'     => __( 'Display sales total for the logged-in user only', 'woocommerce-point-of-sale' ),
					'desc_tip' => __( 'Check this box to show sales totals for orders processed by the logged-in user only.', 'woocommerce-point-of-sale' ),
					'id'       => 'wc_pos_display_total_sales_for_logged_in_user',
					'default'  => 'no',
					'type'     => 'checkbox',
				],
				[
					'title'    => __( 'Separate Product Rows', 'woocommerce-point-of-sale' ),
					'desc'     => __( 'Itemize products in the cart and on the receipt in separate rows', 'woocommerce-point-of-sale' ),
					'desc_tip' => __( 'Check this box to display each product as its own line item in both the cart and the receipt.', 'woocommerce-point-of-sale' ),
				...
				[
					...
					'desc_tip' => __( 'Allows shop managers to take over an open register.', 'woocommerce-point-of-sale' ),
