		...
		return apply_filters(
			...
			[
				...
				[
					...
					'desc'  => __( 'Adjust these settings to manage how the POS application retrieves data from the server, enhancing performance and preventing errors.', 'woocommerce-point-of-sale' ),
					'type'  => 'title',
					'id'    => 'loading_options',
				],
				[
					...
					'desc_tip'          => __( 'Controls the number of simultaneous API requests to the server. Reducing this number can help avoid overloading the server during peak times.', 'woocommerce-point-of-sale' ),
				...
				[
					...
					'desc_tip'          => __( 'Determines how many items are fetched with each request. A lower number reduces server strain but may increase overall loading time.', 'woocommerce-point-of-sale' ),
