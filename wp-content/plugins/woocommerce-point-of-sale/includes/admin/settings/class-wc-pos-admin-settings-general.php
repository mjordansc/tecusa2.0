	...
	public static function get_settings() {
		...
		return apply_filters(
			...
			[
				...
				[
					'name'     => __( 'Manage Stock', 'woocommerce-point-of-sale' ),
					'desc_tip' => __( 'Select the user roles permitted to manage stock.', 'woocommerce-point-of-sale' ),
					'id'       => 'wc_pos_manage_stock_roles',
					'class'    => 'wc-enhanced-select',
					'type'     => 'multiselect',
					/**
					 * User roles permitted to manage stock.
					 *
					 * @since 6.4.0
					 */
					'options'  => apply_filters(
						'wc_pos_manage_stock_roles',
						[
