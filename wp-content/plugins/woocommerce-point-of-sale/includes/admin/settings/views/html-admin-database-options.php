...
$force_updates = [
	...
	'6.3.0' => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-6.3.0.php',
	'6.4.0' => WC_POS_ABSPATH . '/includes/updates/wc_pos-update-6.4.0.php',
];

if ( ! empty( $_POST['wc_pos_force_update_database'] ) ) {
	check_admin_referer( 'woocommerce-settings' );

	$last_update['date'] = gmdate( WC_POS_SQL_DATETIME_FORMAT );
