	...
	foreach ( $current_registers as $register ) {
		...
		$pid = wp_insert_post(
			[
				...
				'meta_input'  => [
					'date_opened'     => wc_string_to_timestamp( get_gmt_from_date( gmdate( WC_POS_SQL_DATETIME_FORMAT, wc_string_to_timestamp( $register->opened ) ) ) ),
					'date_closed'     => wc_string_to_timestamp( get_gmt_from_date( gmdate( WC_POS_SQL_DATETIME_FORMAT, wc_string_to_timestamp( $register->closed ) ) ) ),
