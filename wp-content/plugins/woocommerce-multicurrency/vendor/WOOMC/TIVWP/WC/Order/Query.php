...
namespace WOOMC\Dependencies\TIVWP\WC\Order;
...
class Query {
	 ...
	 */
	public function set_query_arg( string $k, $v ) {
		$this->query_args[ $k ] = $v;
	}
	 ...
	 * @return self
	 */
	public function restrict_to_paid(): Query {
	 ...
	 * @return self
	 */
	public function restrict_to_user_id( int $user_id ): Query {
	 ...
	 * @return self
	 */
	public function restrict_to_after_date( int $value, string $units ): Query {
	 ...
	 * @return self
	 */
	public function set_sorting_by_id_desc(): Query {
	 ...
	 * @since        1.5.0
	 *
	 * @return \WC_Order[]|\stdClass Orders.
	 */
